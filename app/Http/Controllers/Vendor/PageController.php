...
class PageController extends Controller
{
    ...
    {
        $pages = Page::all();
        return view('vendor.pages.index', compact('pages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.pages.index')->with('success', 'Page created successfully.');
    }

    public function edit(Page $page)
    {
        return view('vendor.pages.edit', compact('page'));
    }
    ...
    public function update(Request $request, Page $page)
    {
        ...
        return redirect()->route('vendor.pages.index')->with('success', 'Page updated successfully.');
    }
    ...
    public function destroy(Page $page)
    {
        ...
        $page->delete();
        return redirect()->route('vendor.pages.index')->with('success', 'Page deleted successfully.');
    }

    public function show(Page $page)
    {
        $processedContent = $page->processContent();
        return view('vendor.pages.show', compact('page', 'processedContent'));
    }
