...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{ route('vendor.affiliate.orders.update', $order->id) }}" method="POST">
                @csrf
                @method('PUT')
...
<script>
    ...
    function deleteproduct(productId) {
        if (confirm("Are you sure you want to delete this Variant?")) {
            ...
            $.ajax({
                url: "{{ route('vendor.affiliate.products.variations.destroy', '') }}/" + productId, // Add variation ID to the URL
                type: "DELETE",
                data: {
