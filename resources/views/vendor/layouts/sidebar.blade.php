        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                    <a class="nav-link {{request()->routeIs('vendor.affiliate.dashboard')?'active':''}}" aria-current="page" href="{{route('vendor.affiliate.dashboard')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                    <a class="nav-link {{request()->routeIs('vendor.vendor.dashboard')?'active':''}}" aria-current="page" href="{{route('vendor.vendor.dashboard')}}">
                            <i class="icon">
                                <i class="bi bi-house-door"></i>
                            </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('vendor.products.*')?'active':''}}" aria-current="page" href="{{route('vendor.products.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('vendor.category.*')?'active':''}}" aria-current="page" href="{{route('vendor.category.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('vendor.tags.*')?'active':''}}" aria-current="page" href="{{route('vendor.tags.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('vendor.attributes.*')?'active':''}}" aria-current="page" href="{{route('vendor.attributes.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#manage-orders" role="button" aria-expanded="false" aria-controls="manage-orders">
                            <i class="icon">
                            ...
                            <span class="item-name">Manage Orders</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="manage-orders" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.orders.*') && (!request()->routeIs('vendor.orders.completed') || request()->routeIs('vendor.orders.canceled'))?'active':''}}" aria-current="page" href="{{route('vendor.orders.index')}}">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.orders.completed') ?'active':''}}" aria-current="page" href="{{route('vendor.orders.completed')}}">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.orders.canceled')?'active':''}}" aria-current="page" href="{{route('vendor.orders.canceled')}}">
                                    <i class="icon">
                                    <i class="bi bi-file-text"></i>
                                    </i>
                                    <span class="item-name">Cancled</span>
                                </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#affiliate-orders" role="button" aria-expanded="false" aria-controls="affiliate-orders">
                            <i class="icon">
                            ...
                            <span class="item-name">Affiliate Orders</span>
                            <i class="right-icon">
                                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <ul class="sub-nav collapse" id="affiliate-orders" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.affiliate.orders.*') && (!request()->routeIs('vendor.affiliate.orders.completed') || request()->routeIs('vendor.affiliate.orders.canceled'))?'active':''}}" aria-current="page" href="{{route('vendor.affiliate.orders.index')}}">
                                    <i class="icon">
                                    <i class="bi bi-ui-checks"></i>
                                    </i>
                                    <span class="item-name">Orders</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.affiliate.orders.completed') ?'active':''}}" aria-current="page" href="{{route('vendor.affiliate.orders.completed')}}">
                                    <i class="icon">
                                    <i class="bi bi-file-text"></i>
                                    </i>
                                    <span class="item-name">Completed</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.affiliate.orders.canceled')?'active':''}}" aria-current="page" href="{{route('vendor.affiliate.orders.canceled')}}">
                                    <i class="icon">
                                    <i class="bi bi-file-text"></i>
                                    </i>
                                    <span class="item-name">Cancled</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#blogs" role="button" aria-expanded="false" aria-controls="blogs">
                            ...
                            <span class="item-name">Manage Blogs</span>
                            <i class="right-icon">
                                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <ul class="sub-nav collapse" id="blogs" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.blogs.*') && (!request()->routeIs('vendor.blogcategories.*') || request()->routeIs('vendor.blogtag.*'))?'active':''}}" aria-current="page" href="{{route('vendor.blogs.index')}}">
                                    <i class="icon">
                                    <i class="bi bi-ui-checks-grid"></i>
                                    </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.blogcategories.*')?'active':''}}" aria-current="page" href="{{route('vendor.blogcategories.index')}}">
                                    <i class="icon">
                                    <i class="bi bi-file-text"></i>
                                    </i>
                                    <span class="item-name">Categories</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('vendor.blogtag.*')?'active':''}}" aria-current="page" href="{{route('vendor.blogtag.index')}}">
                                    <i class="icon">
                                    <i class="bi bi-file-text"></i>
                                    </i>
                                    <span class="item-name">Tags</span>
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('vendor.blogs.*')?'active':''}}" aria-current="page" href="{{route('vendor.blogs.index')}}">
                            <i class="icon">
                            <i class="bi bi-ui-checks-grid"></i>
                            </i>
                            <span class="item-name">Blogs</span>
