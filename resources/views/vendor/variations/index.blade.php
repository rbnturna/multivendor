...
<div class="container">
    ...
    <a href="{{ route('vendor.variations.create') }}" class="btn btn-primary">Create Variation</a>
    ...
    <h2>Attributes</h2>
    <a href="{{ route('vendor.attributes.create') }}" class="btn btn-primary">Create Attribute</a>
    <table class="table mt-4">
        <thead>
            <tr>
                <th>Name</th>
            ...
            @foreach($attributes as $attribute)
                <tr>
                    ...
                    <td>@foreach($attribute->values as $value)
                        ...
                        @endforeach</td>
                    <td>
                        <a href="{{ route('vendor.attributes.edit', $attribute) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('vendor.attributes.destroy', $attribute) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
