                            ...
                            <div class="header-title">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                     <a href="{{ route('superadmin.products.variations.create',$product->id) }}" class="btn btn-primary float-end">Create Variation</a>
                                    </div>
                                </div>
                                ...
                                <table class="table table-sm mt-4">
                                    ...
                                    @foreach($product->variations as $variation)
                                            ...
                                            <tr id="variation-row-{{$variation->id}}">
                                                ...
                                                <td>
                                                    <a href="{{route('superadmin.products.variations.edit', [$product->id, $variation->id]) }}" class="btn btn-light btn-sm"><i class="bi bi-pencil-fill text-warning fs-5"></i></a>
