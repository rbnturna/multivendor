        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                    <a class="nav-link {{request()->routeIs('superadmin.affiliate.dashboard')?'active':''}}" aria-current="page" href="{{route('superadmin.affiliate.dashboard')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                    <a class="nav-link {{request()->routeIs('superadmin.vendor.dashboard')?'active':''}}" aria-current="page" href="{{route('superadmin.vendor.dashboard')}}">
                            <i class="icon">
                                <i class="bi bi-house-door"></i>
                            </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('superadmin.products.*')?'active':''}}" aria-current="page" href="{{route('superadmin.products.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('superadmin.category.*')?'active':''}}" aria-current="page" href="{{route('superadmin.category.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('superadmin.tags.*')?'active':''}}" aria-current="page" href="{{route('superadmin.tags.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('superadmin.attributes.*')?'active':''}}" aria-current="page" href="{{route('superadmin.attributes.index')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="manage-orders" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('superadmin.orders.*') && (!request()->routeIs('superadmin.orders.completed') || request()->routeIs('superadmin.orders.canceled'))?'active':''}}" aria-current="page" href="{{route('superadmin.orders.index')}}">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('superadmin.orders.completed') ?'active':''}}" aria-current="page" href="{{route('superadmin.orders.completed')}}">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('superadmin.orders.canceled')?'active':''}}" aria-current="page" href="{{route('superadmin.orders.canceled')}}">
                                    <i class="icon">
                                    <i class="bi bi-file-text"></i>
                                    </i>
