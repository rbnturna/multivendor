        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{route('superadmin.blogs.create')}}" class="btn btn-primary">Add New Blogs</a>
                    </div>
                </div>
                <div class="card-body">
                    <p>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('superadmin.blogs.edit' , $blog->id) }}" class="btn btn-warning btn-sm">Edit</a>
