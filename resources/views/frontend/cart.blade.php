                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="{{ url(path: '/cart') }}" class="dropdown-item">Shopping Cart</a>
                                    <a href="{{ url(path: '/checkout') }}" class="dropdown-item active">Checkout</a>
                                </div>
                            </div>
                            <a href="{{ url(path: '/contact') }}" class="nav-item nav-link">Contact</a>
                        </div>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="{{ asset('frontend/img') }}/product-1.jpg" alt="" style="width: 50px;"> Product Name</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="{{ asset('frontend/img') }}/product-2.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="{{ asset('frontend/img') }}/product-3.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="{{ asset('frontend/img') }}/product-4.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="{{ asset('frontend/img') }}/product-5.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
